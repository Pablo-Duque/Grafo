...
public class Grafo extends JFrame {
    ...
    private void initializeGraph() {
        ...
        System.out.println(acharMenorCaminho("Sao Paulo", "Bauru"));
    ...
    public int acharMenorCaminho(String origemNome, String destinoNome){
        int [] distancias = dijk.dijkstra(origemNome);
        return distancias[index.indexOf(destinoNome)];
    }
